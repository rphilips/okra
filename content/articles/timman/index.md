...
.diagram timman.pgn
-->
<div style='cursor:pointer' onclick='navigator.clipboard.writeText("7B/8/8/4K3/6p1/7N/5PpP/4k3 w - - 0 1"); return false'>
...
[Result "*"]
[SetUp "1"]
[FEN "7B/8/8/4K3/6p1/7N/5PpP/4k3 w - - 0 1"]
[Link "https://www.chess.com/analysis/game/pgn/4iBphQRWVt/analysis"]

1. Ng1 $1 Kxf2 2. Nh3+ $1 Kf1 3. Kf4 $3 g1=Q 4. Nxg1 $1 Kg2 5. Kxg4 Kxh2 6. Ne2 *`, position: 'start', showCoords: true, orientation: 'white', theme: 'blue', pieceStyle: 'wikipedia', figurine: 'merida', locale: 'en', timerTime: '', layout: 'top', showFen: false, coordsInner: false, manyGames: false, coordsFactor: '1.0', coordsFontSize: '', colorMarker: '', startPlay: '', hideMovesBefore: true, notation: 'long', notationLayout: 'list', resizable: true, headers: false,};

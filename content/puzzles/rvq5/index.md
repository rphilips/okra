...
[Result "1-0"]
[SetUp "1"]
[FEN "8/q7/1k6/8/8/2K1R2R/8/8 w - - 0 1"]
[Link "https://www.chess.com/analysis/game/pgn/39vBGT1Pin/analysis"]

1. Re6+ Kb5 2. Re5+ Ka4 3. Re4+ $1 Ka3 4. Kc4+ $1 Ka4 5. Kd5+ Kb5 6. Rb3+ $1 Ka6 $6 7.
Ra4# 1-0`, position: 'start', showCoords: true, orientation: 'white', theme: 'blue', pieceStyle: 'wikipedia', figurine: 'merida', locale: 'en', timerTime: '', layout: 'top', showFen: false, coordsInner: false, manyGames: false, coordsFactor: '1.0', coordsFontSize: '', colorMarker: '', startPlay: '', hideMovesBefore: true, notation: 'long', notationLayout: 'list', resizable: true, headers: false,};
